...
import static utils.AppointmentDAO.updateAppointment;
...
public class UpdateAppointmentController implements Initializable {
    ...
    public void loadAppointment(Appointment appointment) throws SQLException
    {
        ...
        StartDropDown.setValue(selectedAppointment.getStart().toLocalDateTime().atZone(ZoneId.of("UTC")).withZoneSameInstant(ZoneId.of(ZoneId.systemDefault().toString())).toLocalTime());
        
    }
    
    public void updateAppointmentButton(ActionEvent event) throws SQLException, IOException{
        ...
        if(appointmentOverlap.isEmpty() || appointmentOverlap.get(0).getStart().equals(selectedAppointment.getStart())){
            updateAppointment(selectedAppointment.getAppointmentId(), type, contact, customerId, startTimestamp, endTimestamp);
